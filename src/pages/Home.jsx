...
export default function Home() {
  return (
    <main className="relative min-h-[100svh] overflow-hidden bg-[#f6f4ef]">
      ...
      <div className="relative mx-auto flex min-h-[100svh] max-w-7xl items-start justify-center px-4 pb-8 pt-14 sm:px-8 sm:pb-10 sm:pt-16 lg:px-12 lg:pb-12 lg:pt-16">
